...
load_dotenv(BASE_DIR / ".env")  # Garante que o .env seja carregado a partir do BASE_DIR
...
SECRET_KEY = 'django-insecure-%uj)q+66ene8qw84_*@xh1i4k#i1pu5tdwpu)6-)_)#51nt+eq'
