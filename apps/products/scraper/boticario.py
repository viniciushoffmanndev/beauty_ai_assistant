...
from apps.products.constants import BOTICARIO_SOURCE, DEFAULT_HEADERS, MIN_VALID_PRODUCTS
...
class BoticarioScraper:
    ...
    def _parse_products(self, html: str) -> list[ProductScrapedDTO]:
        ...
        for item in articles:
            try:
                ...
                errors += 1
                logger.warning("Erro ao processar produto: %s", exc, exc_info=True)
    ...
    def _parse_embedded_json(raw_value: str) -> dict:
        ...
        try:
            ...
            raise EmbeddedJsonParseError("Erro ao interpretar data-event")